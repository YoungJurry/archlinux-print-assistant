...
- 微信/QQ 剪贴板图片通过 Ctrl+V 保存至 `/tmp/pi-print/` 并添加
...
```bash
git clone https://github.com/YoungJurry/pi-print-assistant.git
cd pi-print-assistant
makepkg -si
```

安装后可从 XFCE 应用菜单启动“Pi 打印助手”，或在 Thunar 中右键文件选择“打开方式”。

## 卸载

```bash
sudo pacman -Rns pi-print-assistant
```
